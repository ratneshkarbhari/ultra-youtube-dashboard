...
<head>
    ...
    <title>{{$title}} | Ultra - YouTube Dashboard</title>
...
<body>
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white bg-dark" href="admin/dashboard/">
            <img src="{{ url('assets/images/logo.svg'); }}" alt="" class="img-fluid ultra-logo"> 
        </a>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary border-bottom-0">
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
                    aria-labelledby="sidebarMenuLabel">
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="sidebarMenuLabel">
                            <a href="admin/dashboard/">
                                <img src="{{ url('assets/images/logo.svg'); }}" alt="" class="img-fluid" style="width:80px"> 
                            </a>
                        </h5>
